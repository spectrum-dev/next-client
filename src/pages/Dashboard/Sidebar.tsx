...
const SidebarElement = ({ label, route, action, children }: { label: string, route?: string, action?: Function, children: React.ReactNode }) => {
...
const Sidebar = () => {
  ...
  return (
        <Box position="fixed" left="0px" top="0px" height="100%" width="85px" backgroundColor="white" boxSizing="border-box" borderRightWidth="1px" borderRightStyle="solid" borderRightColor="#e7e9f3">
            ...
            <Flex justifyContent="center" alignItems="center" bottom="0px" position="absolute" width="100%" borderTopWidth="1px" borderRightStyle="solid" borderRightColor="#e7e9f3" flexDirection="column">
                ...
                <SidebarElement label="Log Out" action={signOut}>
